...
export class InvoiceService {
    ...
    async getInvoices(companyId: string, pagination: PaginationQuery): Promise<PaginatedResult<Invoice>> {
        const queryResponse = await this.invoiceRepository.getInvoicesByCompanyId(companyId, pagination);
        return queryResponse;
    }

    async getInvoiceById(invoiceId: string, companyId: string): Promise<Invoice | null> {
